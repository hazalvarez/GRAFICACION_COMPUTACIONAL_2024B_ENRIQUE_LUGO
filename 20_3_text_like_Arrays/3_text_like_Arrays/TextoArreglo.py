...
class ChangeSize(Scene):
    def construct(self):
        ...
        self.add(text)
        self.wait()
        text.scale(2)  # Cambia scale_in_place por scale
        self.wait(2)
...
class FadeTextFromDirection(Scene):
    def construct(self):
        text = Tex("Text or object")
        text.move_to(UP)  # Mueve el texto al lugar de entrada inicial
        self.play(FadeIn(text, shift=DOWN), run_time=1)  # Usa shift para simular entrada desde abajo
        self.wait()
...
class ShowCreationObject(Scene):
    def construct(self):
        text = Tex("Text or object")
        self.play(Create(text), run_time=1)  # Reemplaza ShowCreation por Create
        self.wait()
...
"""
manim -pql TextoArreglo.py TextColor -qh
manim -pql TextoArreglo.py FormulaColor1 -qh
manim -pql TextoArreglo.py FormulaColor2 -qh
manim -pql TextoArreglo.py FormulaColor3 -qh
manim -pql TextoArreglo.py FormulaColor3Fixed -qh
manim -pql TextoArreglo.py FormulaColor3Fixed2 -qh
manim -pql TextoArreglo.py FormulaColor4 -qh
manim -pql TextoArreglo.py FormulaColor5 -qh
manim -pql TextoArreglo.py ColorByCaracter -qh
manim -pql TextoArreglo.py ColorByCaracterFixed -qh
manim -pql TextoArreglo.py ListFor -qh
manim -pql TextoArreglo.py ForRange1 -qh
manim -pql TextoArreglo.py ForRange2 -qh
manim -pql TextoArreglo.py ForTwoVariables -qh
manim -pql TextoArreglo.py ChangeSize -qh
manim -pql TextoArreglo.py AddAndRemoveText -qh
manim -pql TextoArreglo.py FadeText -qh
manim -pql TextoArreglo.py FadeTextFromDirection -qh
manim -pql TextoArreglo.py GrowObjectFromCenter -qh
manim -pql TextoArreglo.py ShowCreationObject -qh
manim -pql TextoArreglo.py ColoringText -qh
manim -pql TextoArreglo.py CrossText1 -qh
manim -pql TextoArreglo.py CrossText2 -qh
manim -pql TextoArreglo.py FrameBox1 -qh
manim -pql TextoArreglo.py FrameBox2 -qh
manim -pql TextoArreglo.py BraceText -qh
